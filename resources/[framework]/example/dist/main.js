...
// CONCATENATED MODULE: ../[dependancies]/src/utils/weather_enum.ts
var WeatherTypeHash;
...
//Thread used to get and show all the connected players name : 
setTick(() => src_awaiter(void 0, void 0, void 0, function* () {
    const player = getPlayers();
    for (let p of player)
        console.log(GetPlayerName(p));
    yield Wait(6000); //Each 6 seconds it will show all the name of all connected players.
}));
